...
<section class="vh-100">
    <div class="form-group">
        ...
        <p class="text-center h1 fw-bold">Edit article</p>
        <form:form action="${pageContext.request.contextPath}/article/${articleDto.getId()}" method="POST"
                   modelAttribute="articleDto" class="mx-1 mx-md-4">
            ...
            <div class="d-flex justify-content-center mb-4">
                <input formaction="${pageContext.request.contextPath}/article/delete/${articleDto.getId()}" type="submit" formmethod="POST" value="Delete" class="btn btn-danger btn-lg w-100 p-1"/>
            </div>
